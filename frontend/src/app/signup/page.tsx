        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 text-sm">
              Register to access infrastructure visualizer
            </p>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-700/50 rounded-lg p-8 backdrop-blur-sm">
            ...
            {error && (
              <div className="mb-6 p-4 bg-red-900/20 border border-red-700/50 rounded-lg flex items-start gap-3">
                ...
                <div>
                  <div className="text-red-300 text-sm font-medium">Registration Error</div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-slate-800/50 border rounded-lg text-slate-100 placeholder-slate-500 text-sm transition-all duration-200 focus:outline-none ${
                      focusedField === 'email'
          ...
          <div className="mt-6 flex items-start gap-2 text-xs text-slate-500 px-1">
            ...
            <span>Encrypted connection. Your data is protected.</span>
          </div>
        </div>
      </main>
